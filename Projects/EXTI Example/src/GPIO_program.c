...
void GPIO_voidSetPinDir( u8 Copy_u8Port , u8 Copy_u8Pin , u8 u8Copy_u8Mode ){
...
void GPIO_u8TogglePin(u8 Copy_u8Port , u8 Copy_u8Pin)
{
	switch(Copy_u8Port)
	{
	case GPIOA: GPIOA_ODR^=(1<<Copy_u8Pin);  break;
	case GPIOB: GPIOB_ODR^=(1<<Copy_u8Pin);  break;
	case GPIOC: GPIOC_ODR^=(1<<Copy_u8Pin);  break;
	}
}
