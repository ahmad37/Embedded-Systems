...
#define  EXTI_LINE1_ENABLE     (0)         /*PINA1,PIB1,PINC1,...*/
#define  EXTI_LINE2_ENABLE     (0)
#define  EXTI_LINE3_ENABLE     (0)
#define  EXTI_LINE4_ENABLE     (0)
#define  EXTI_LINE5_ENABLE     (0)
#define  EXTI_LINE6_ENABLE     (0)
#define  EXTI_LINE7_ENABLE     (0)
#define  EXTI_LINE8_ENABLE     (0)
#define  EXTI_LINE9_ENABLE     (0)
#define  EXTI_LINE10_ENABLE    (0)
...
#define  EXTI_LINE1_EDGE     (0)
#define  EXTI_LINE2_EDGE     (0)
#define  EXTI_LINE3_EDGE     (0)
#define  EXTI_LINE4_EDGE     (0)
#define  EXTI_LINE5_EDGE     (0)
#define  EXTI_LINE6_EDGE     (0)
#define  EXTI_LINE7_EDGE     (0)
#define  EXTI_LINE8_EDGE     (0)
#define  EXTI_LINE9_EDGE     (0)
#define  EXTI_LINE10_EDGE    (0)
